...
const Movies = () => {
    ...
    const getTrending = async () => {
        ...
        https://api.themoviedb.org/3/discover/movie?api_key=f1aca93e54807386df3f6972a5c33b50&language=en-US
    ...
    return (
        <Container>
            <h4 className='trending-header'>Trending Movies</h4>
            <GenresCustom 
                type='movie'
                setPage={setPage}
                Genre={Genre}
            ...
            {trendingAll.map((trending) => (
                    ...
                    sm={1}
                >
                    <TrendingItem trending={trending} media_type='movie' />
                </Col>
                ))}
            </Row>
